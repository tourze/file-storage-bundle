...
final class ValidateFileController extends AbstractController
{
    ...
    public function __invoke(string $id, Request $request): Response
    {
        ...
        $this->addFlash('success', sprintf('文件 %s 已设置为有效', $file->getOriginalName() ?? 'unknown'));
        ...
        return $this->json(['success' => true, 'message' => 'File validated successfully']);
    }
}
